...
class LidarScanModuleViewController: GLKViewController, ARSessionDelegate, RTABMapObserver, UIPickerViewDataSource, UIPickerViewDelegate, CLLocationManagerDelegate {
    ...
    private func updateState(state: State)
    {
        ...
        menuButton.addTarget(self, action: #selector(LidarScanModuleViewController.menuOpened(_:)), for: .menuActionTriggered)
        ...
        viewButton.addTarget(self, action: #selector(LidarScanModuleViewController.menuOpened(_:)), for: .menuActionTriggered)
    }
    ...
    {
        //Step : 1
        let alert = UIAlertController(title: "Save Scan", message: "Carrt-Measure Room Database Name (*.db):", preferredStyle: .alert )
        //Step : 2
...
extension LidarScanModuleViewController: VerticalScrollerViewDelegate {
...
extension LidarScanModuleViewController: VerticalViewDataSource {
...
extension LidarScanModuleViewController: DatabaseViewDelegate {
