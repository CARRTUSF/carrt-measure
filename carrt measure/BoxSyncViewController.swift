...
class BoxSyncViewController: UITableViewController, ASWebAuthenticationPresentationContextProviding {
...
private extension BoxSyncViewController {
    func getOAuthClient() {
...
extension BoxSyncViewController: PreviewViewControllerDelegate {
...
extension BoxSyncViewController {
    @available(iOS 13.0, *)
